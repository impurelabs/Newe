...
Doctrine_Manager::getInstance()->bindComponent('ProfileCompany', 'doctrine');
 ...
 * @method ProfileCompany setAccountId()         Sets the current record's "account_id" value
 * @method ProfileCompany setName()              Sets the current record's "name" value
 * @method ProfileCompany setBrandName()         Sets the current record's "brand_name" value
 * @method ProfileCompany setSlogan()            Sets the current record's "slogan" value
 * @method ProfileCompany setCui()               Sets the current record's "cui" value
 * @method ProfileCompany setContactName()       Sets the current record's "contact_name" value
 * @method ProfileCompany setContactJobTitle()   Sets the current record's "contact_job_title" value
 * @method ProfileCompany setContactEmail()      Sets the current record's "contact_email" value
 * @method ProfileCompany setContactPhone()      Sets the current record's "contact_phone" value
 * @method ProfileCompany setLocationId()        Sets the current record's "location_id" value
 * @method ProfileCompany setLocation()          Sets the current record's "Location" value
 * @method ProfileCompany setAccount()           Sets the current record's "Account" value
 * 
 * @package    newe
 * @subpackage model
