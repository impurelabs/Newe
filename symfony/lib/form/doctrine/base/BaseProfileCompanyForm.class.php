...
/**
 * ProfileCompany form base class.
 *
 * @method ProfileCompany getObject() Returns the current form's model object
 *
 * @package    newe
 * @subpackage form
 ...
 */
abstract class BaseProfileCompanyForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('profile_company[%s]');
