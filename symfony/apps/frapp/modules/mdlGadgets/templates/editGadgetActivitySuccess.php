<div class="p-2">
  ...
  <div class="cell-bd">
    ...
    <div class="cell-bd-content">
      ...
      <?php echo $form->renderGlobalErrors()?> <?php echo $form->renderHiddenFields()?> <?php echo $form['gadget_name']->renderLabel()?><br />
      <?php echo $form['gadget_name']->render(array('style' => 'width: ' . $gadget['width'] . 'px'))?><br />
      <?php echo $form['gadget_name']->renderError()?><br />
      <div class="mt-2"></div>
      <?php echo $form['limit']->renderLabel()?><br />
      <?php echo $form['limit']->render()?><br />
      <?php echo $form['limit']->renderError()?><br />
      <div class="mt-2"></div>
      <?php echo $form['type_classes']->renderLabel()?><br />
      <?php echo $form['type_classes']->render()?><br />
      <?php echo $form['type_classes']->renderError()?><br />
    </form>
  </div>
</div>
<!-- cell-bd end -->
