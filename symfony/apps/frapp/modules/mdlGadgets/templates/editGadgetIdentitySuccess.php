<div class="p-2">
  ...
  <div class="cell-bd">
    ...
    <a class="small strong" href="<?php echo url_for(array('sf_route' => 'plugin_gadgets_actions', 'action' => 'editGadget', 'microsite_slug' => $thisMicrosite->getSlug(), 'plugin_slug' => $gadget->getPlugin()->getSlug()));?>">
