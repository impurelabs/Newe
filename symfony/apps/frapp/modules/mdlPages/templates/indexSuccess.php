...
<div class="admin-cell">
  <button onclick="location.href='<?php echo url_for(array('sf_route' => 'plugin_pages_edit', 'microsite_slug' => $thisMicrosite->getSlug(), 'plugin_slug' => $plugin->getSlug(), 'slug' => $page->getSlug()))?>'" type="button"><span class="icon-button-edit mr-1"></span><?php echo __('Edit page')?></button>
...
function deletePage()
{
	...
	$.post( '<?php echo url_for(array('sf_route' => 'plugin_pages_delete', 'microsite_slug' => $thisMicrosite->getSlug(), 'plugin_slug' => $plugin->getSlug(), 'slug' => $page->getSlug()))?>', { page_id: <?php echo $page->getId()?>}, function(data){
	  location.href ="<?php echo url_for(array('sf_route' => 'plugin_pages_index', 'microsite_slug' => $thisMicrosite->getSlug(), 'plugin_slug' => $plugin->getSlug()))?>"
	}); 
}
